...
class ServiceController extends Controller
{
  ...
  public function postadd(Request $Request)
  {
    ...
    try{
      ...
      $service->save();
      return redirect('admin/service/get')->with('thongbao','bạn đã thêm thành công');
    }
    catch(Exception $e) {
  ...
  public function postupdate(Request $Request, $id_service)
  {
    ...
    try{
      ...
      $service->describe=$Request->describe;
      $service->save();
      return redirect('admin/service/get')->with('thongbao','bạn đã sửa thành công');
    }
    catch(Exception $e) {
  ...
  public function searchData(Request $Request)
  {
    ...
    return ['data'=>$service,'name'=>'service'];
  }
}
