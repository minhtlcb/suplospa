    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>
            @if(Cookie::has('username')){!! Cookie::get('username') !!}@else CHƯA ĐĂNG NHẬP @endif 
          </p>
          <a href="#"><i class="fa fa-circle text-success"></i>
            Role @if(Session::has('role')){!! Session::get('role') !!}@else NONE @endif 
          </a>
        </div>
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          {{--  class="active"> --}}
            <li><a href="{{url('admin/index')}}"><i class="fa fa-circle-o"></i> HOME v1</a></li>
            <li><a href="{{url('admin/index2')}}"><i class="fa fa-circle-o"></i> HOME v2</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            @can('admin') <li><a href="{{url('admin/user/get')}}"><i class="fa fa-circle-o"></i>Quản lý User</a></li> @endcan
          </ul>
        </li>
      {{--   <li>
        ...
        <li>
          <a href="{{url('admin/statistical/order_statistics')}}">
