        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
                @if(Cookie::has('username')){{ Cookie::get('username') }}@else CHƯA ĐĂNG NHẬP @endif - Web Developer
                <small>
                  Member since @if(Session::has('created_at')){{ Session::get('created_at') }}@else NONE @endif
                </small>
              </p>
            </li>
            <!-- Menu Body -->
