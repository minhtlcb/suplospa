        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">@if(isset($_SESSION['username'])){!! $_SESSION['username'] !!}@else CHƯA ĐĂNG NHẬP @endif </span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  @if(isset($_SESSION['username'])){!! $_SESSION['username'] !!}@else CHƯA ĐĂNG NHẬP @endif - Web Developer
