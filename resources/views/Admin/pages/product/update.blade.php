...
<p>Mô tả ngắn</p><textarea id="textarea1" name="short_description">{{$product->short_description}}"</textarea>
<p>Mô tả chi tiết</p><textarea id="textarea2" name="long_description">{{$product->long_description}}"</textarea>
