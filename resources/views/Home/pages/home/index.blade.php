...
<!-- start class video -->
            <div class="test">
                ...
                <div class="video">
                    <video width="100%" playsinline="" autoplay="" muted="" loop="" poster="http://file.hstatic.net/1000185703/file/videobg-start.png" id="bgvid1" class="stopfade">
                        <source src="http://file.hstatic.net/1000185703/file/videobg.webm" type="video/webm">
                        <source src="http://file.hstatic.net/1000185703/file/videobg.mp4" type="video/mp4">
                    </video>
                </div>

                <div class="text">
                    <h1 class="toasang">Tỏa Sáng Nét Đẹp Á Đông</h1>
                    <h2>
<p>
        Thấu hiểu và tôn vinh nét đẹp người phụ nữ á đông, Suplo beauty & spa tự hào đem đến cho khách hàng
        
        những dịch vụ tốt nhất, các sản phẩm chăm sóc da cao cấp cùng không gian thư giãn sang trọng 
        
        mang đậm dấu ấn riêng của kiến trúc nhật bản cổ
      </p>
      <input type="submit" onclick="javascrip:alert('hello');" name="bntxemthem" class="xemthem" value="XEM THÊM >>">
    </h2>
  ...
  <div class="row main-stree">
    <div class="col-md-6 ">
         <div class="main-text">
           ...
           {{-- <h2 class="main-text-suplo">SUPLO BEAUTY & SPA</h2> --}}
   ...
   <div class="col-md-12">
     <div class=" row maindichvu-content">
        ...
        <div class="col-md-5 box-img" id="picture">
          <img id="picture-img" class="maindichvu-content-img" src="public/img/massage-da-nong_52899887d012446baa068beddb851a44_large.webp">
        </div>
    ...
    <div class="col-md-12">
      ...
      <div class=" col-md-3 col-sm-4">
        <div class="main-people-img text-center">
          <img id="image1" src="public/img/1.people.webp">
        </div>
      </div>
      <div class="col-md-3 col-sm-4">
        <div class="main-people-img text-center">
          <img id="image2" src="public/img/2.people.webp">
        </div>
      </div>
      <div class="col-md-3 col-sm-4">
        <div class="main-people-img text-center">
          <img id="image3" src="public/img/3.people.webp">
        </div>
      </div>
      <div class="col-md-3 col-sm-4">
        <div class="main-people-img text-center">
          <img id="image4" src="public/img/5.people.webp">
        </div>
      </div>
      </div>
    </div>
        ...
        <div class="col-md-3">
          <div class="card">
            ...
            <div class="card-body main-the">
              ...
              <div class="btn-mua">
                <button class="btn btn-outline-secondary"><a href="{{url('productdetails/'.$value->id_product)}}">Xem chi tiết</a></button>
                <button class="btn btn-outline-secondary"><a href="{{url('cart/'.$value->id_product)}}">Mua</a></button>
              </div>
            </div>
          </div>
        </div>
...
{{-- <div class="container dangki">
  <div class="row dangkithahvien">
    <div class="row">
    <div class="col-md-12 dangkithanhvien-title text-center">
      <h2 class="title-chungtoi">Chúng tôi giúp bạn đẹp hơn mỗi ngày</h2>
      <h2 class="title-dangkithanh">ĐĂNG KÝ THÀNH VIÊN</h2>
      <p class="title-neu">Nếu bạn còn đang băn khoăn về một địa chỉ làm đẹp đáng tin cậy, hãy để Suplo Beauty & Spa đồng hành cùng bạn ngay hôm nay. Với đẳng cấp vượt trội mang tầm quốc tế, Suplo xứng đáng là chốn thiên đường, chăm sóc cho vẻ đẹp, sức khỏe và tâm hồn của bạn!</p>
    </div>
    <!-=======card adduser========>
    @foreach($membership_pakage as $vale)
    <div class="col-md-4 box-adduser">
        <div class="box-adduser-top">
        <div class="box-adduser-img">
          <img class="img-resize1" src="public/upload/membership_package/{{$vale->image}}" alt="Basic">
        </div>
        <div class="box-adduser-content-in-img">
            <h3>{{$vale->name}}</h3>
            <h2>{{number_format(($vale->price),0,",",".")}}</h2>
        </div>
        </div>
        <ul class="list-box-adduser-ul">
        	{!! $vale->description !!} --}}
    {{--         <li class="list-box-adduser-li">
...
{{--         </ul>
        <div class="box-add-btn">
            ...
            <a href="" class="btn btn-outline-info">Mua ngay</a>
        </div>
    </div>
    @endforeach
...
<style>
 ...
 style="height: 159px;">
  ...
  <div class="pack-actions text-center">
    ...
    <button type="button" class="btnType2 btnBuyNow buy-now" data-id="1012411525">Mua ngay</button>
  </div>
              <div class="owl-item" style="width: 383px;"><div class="item grid__item">
              </div>
                </div>
              </div>  
      <div class="col-md-4 boder123" style="padding-bottom: 10px;">
  @endforeach
  ...
  <div class="row main-people-body">
      ...
      <div class="col-md-6 main-people-box">
        <div class="main-people-box-img">
          <img src="public/img/1.people.webp">
          <div class="content-box-people">
              <p class="main-people-box-text">
