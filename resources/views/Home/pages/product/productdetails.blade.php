    ...
    <div class="container">
        ...
        <div class="col-md-12">
            ...
            <div class="row tieude-chitietsp" style="border-bottom: 2px #cccc solid;">
                    ...
                    <a href="{{Route('trademark',$product->trademark->id_trademark)}}">{{$product->trademark->name}}</a>
                    </div>

                    <div class="loaisp hihii">
                    <span>Loại:</span>
                    <a href="{{Route('product_type',$product->product_type->id_types)}}">{{$product->product_type->name}}</a>
                    </div>
...
<button id="btnminus" onclick="truvl()" type="button" class="btn btn-default btn-number aooo" data-type="plus"> 
   ...
   <div class="aoluong">
    <button type="submit" class="text-center addproduct" value="">Thêm Vào Giỏ Hàng</button>
